...
class ResultScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (var i = 1; i < (v6 + 1); i++) {
      ...
      if (0 < spower2 && spower2 < 2) {
        data3.add(
            '- Harmonic order  1  when the capacitor of  $i  steps is connected.\n');
      } else if (4 < spower2 && spower2 < 6) {
        data3.add(
            '- Harmonic order  5  when the capacitor of  $i  steps is connected.\n');
      } else if (6 < spower2 && spower2 < 8) {
        data3.add(
            '- Harmonic order  7  when the capacitor of  $i  steps is connected.\n');
      } else if (10 < spower2 && spower2 < 12) {
        data3.add(
            '- Harmonic order  11  when the capacitor of  $i  steps is connected.\n');
      } else if (12 < spower2 && spower2 < 14) {
        data3.add(
            '- Harmonic order  13  when the capacitor of  $i  steps is connected.\n');
      } else if (16 < spower2 && spower2 < 18) {
        data3.add(
            '- Harmonic order  17  when the capacitor of  $i  steps is connected.\n');
      } else if (18 < spower2 && spower2 < 20) {
        data3.add(
            '- Harmonic order  19  when the capacitor of  $i  steps is connected.\n');
      } else if (22 < spower2 && spower2 < 24) {
        data3.add(
            '- Harmonic order  23  when the capacitor of  $i  steps is connected.\n');
      } else if (24 < spower2 && spower2 < 26) {
        data3.add(
            '- Harmonic order  25  when the capacitor of  $i  steps is connected.\n');
      } else if (28 < spower2 && spower2 < 30) {
        data3.add(
            '- Harmonic order  29  when the capacitor of  $i  steps is connected.\n');
      } else if (30 < spower2 && spower2 < 32) {
        data3.add(
            '- Harmonic order  31  when the capacitor of  $i  steps is connected.\n');
      } else if (34 < spower2 && spower2 < 36) {
        data3.add(
            '- Harmonic order  35  when the capacitor of  $i  steps is connected.\n');
      } else if (36 < spower2 && spower2 < 38) {
        data3.add(
            '- Harmonic order  37  when the capacitor of  $i  steps is connected.\n');
      } else if (40 < spower2 && spower2 < 42) {
        data3.add(
            '- Harmonic order  41  when the capacitor of  $i  steps is connected.\n');
      }
      // print('$data3');
    }
    ...
    Future<void> createPDF() async {
      ...
      page.graphics.drawString(
          '\n\n\n\n\n\n\n\n\n\n\nRated Power         :  $ratedpowerFromFormScreen   kVA',
          PdfStandardFont(PdfFontFamily.helvetica, 17));
      page.graphics.drawString(
          '\n\n\n\n\n\n\n\n\n\n\n\nCapacitor bank      :   $stepFromFormScreen     Step',
          PdfStandardFont(PdfFontFamily.helvetica, 17));
      page.graphics.drawString(
          '\n\n\n\n\n\n\n\n\n\n\n\n\nCapacitance          :    $qcFromFormScreen    kVAR',
          PdfStandardFont(PdfFontFamily.helvetica, 17));
      page.graphics.drawString(
          '\n\n\n\n\n\n\n\n\n\n\n\n\n\nRated Voltage       :    $ratedvoltageFromFormScreen   V',
          PdfStandardFont(PdfFontFamily.helvetica, 17));
      page.graphics.drawString(
          '\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nThe harmonic sequence that causes the resonance frequency is',
          PdfStandardFont(PdfFontFamily.helvetica, 17));
      page.graphics.drawString(
          '\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n$concatenate',
          PdfStandardFont(PdfFontFamily.helvetica, 17));
